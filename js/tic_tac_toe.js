...
function isSelect(selectSquare) {
    ...
    if (flag === "pen-flag"){
      // Click sound
        ...
        selectSquare.classList.remove("js-clickable");   //squareをクリック可能かを判断するクラスを削除
...
function gameOver (status) {
  ...
  // });
 selectsquaresBox.classList.add("js-unclickable");
...
// classListの使い方まとめ：https://qiita.com/tomokichi_ruby/items/2460c5902d19b81cace5
  ...
  // クマのターン(Computer)のロジック
  bearTurn ();
  gameOverFlg === "0"; 
  bearSquare.squaresArray.filter(square);
  square.classList.add("js-clickable");
  bearSquare.classList.contains("js-clickable");
  Math.floor(Math.random()*bearSquare.length);
